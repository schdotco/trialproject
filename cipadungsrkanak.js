    ...
    try {
        ...
        for (let i = 1; i < cachedSheetData.length; i++) {
            ...
            if (nikSheet === target) {
                ...
                console.log("Isi Kolom 74 (Jiwa 1):", row[74]);
                console.log("Isi Kolom 75 (Jiwa 2):", row[75]);
                console.log("Isi Kolom 76 (Jiwa 3):", row[76]);
                console.log("Isi Kolom 77 (Jiwa 4):", row[77]);
                console.log("================================");
