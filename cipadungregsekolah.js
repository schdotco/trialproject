...
const SHEETS = [{
    ...
    colWA: 12,
    colJK: 8,
    colPekerjaan: 24, // Diabaikan di CKG Sekolah
    colSekolah: 32,   // Pastikan index kolom ini sesuai database 
    colKelas: 56,     // Pastikan index kolom ini sesuai database 
    colDisabilitas: 17, // Pastikan index kolom ini sesuai database 
    colAlamat: 13,
    colMartial: 26,
    waStatis: true
}];
...
function initUI(){
    ...
    box.innerHTML = `
        <div id="dragHeader" style="text-align:center; margin-bottom:10px; cursor:move; background:#222; padding:8px; border-radius:8px; border:1px solid #444;" title="Klik dan tahan untuk menggeser bot">
            ...
            <span style="font-size:10px; color:#aaa; letter-spacing:1px;">UPTD Puskesmas Cipadung</span>
        </div>
